...
const ManageClientsPage = () => {
  ...
  const tableData = [
    { id: 1, name: "Hello", text: "World", number: 2020, desctiption: "Code" },
    { id: 2, name: "Hello", text: "World", number: 2020, desctiption: "Code" },
    { id: 3, name: "Hello", text: "World", number: 2020, desctiption: "Code" },
    ...
    { id: 7, name: "Hello", text: "World", number: 2020, desctiption: "Code" },
  ...
  return (
    <div className={classes.wrapper}>
      ...
      <div className={classes.selected}>
        {!selectedClient ? (
          <>
            <SelectClientIcon width={150} height={150} fill={COLORS.PRIMARY} />
            <h2>Please select a client for editing ...</h2>
          </>
        ) : (
          <FormManageClient
